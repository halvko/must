...
/// Materializing a temporary gives the value storage, never a name — and
/// consuming is done by handing a value somewhere, which needs a name to
/// hand. So the grant stops exactly here, and the message says what to
/// write instead.
